...
?>
		...
		<section class="aside-layout-section padding-top-60 padding-bottom-40">
          ...
          <?php include('includes/business-leads-filter.php');?>
                  ...
                  <?php
                  $query ='SELECT DISTINCT industrylist.industryName, businesslead.businessName, businesslead.leadName, businesslead.leadDescription, businesslead.offerType, businesslead.businessleadid, country.countryName, businesslead.dateofpost,country.countryFlag FROM businesslead
                  ...
                  while($row = $stmtfetch->fetch(PDO::FETCH_GROUP))
                        {
								...
								<div class="entry-figure col-md-2 col-lg-2 col-sm-2 col-xs-12 ">
									<a href="lead-single-listing.php?lid='.$row[5].'"><img class="business-logo thumbnail  img-responsive image-rounded " style="margin:0% auto;" src="images/noimage.jpeg " alt="IMG NOT AVAILABLE" ></a>
								</div>
