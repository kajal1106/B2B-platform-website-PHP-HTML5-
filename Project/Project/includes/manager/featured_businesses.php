		...
		<div class="container-fluid"><!-- section container -->
			<div class="feature-wrap">
				<ul class="feature-slider clearfix">
					...
					<?php
								$stmtfetch = $db->prepare('SELECT business.businessID, businesscontactinformation.businessName, industrylist.industryName, businessprofile.status, country.countryName, country.countryFlag, businesslogo.busienssLogoPath, businessprofile.isverified FROM business
										...
										echo '<li class="item pro"><!-- .ITEM -->
											<div class="feature-item ">
												...
												<div class="feature-content clearfix">
													...
													if($row[7]=='Verify')
														{
															echo '<span class="label label-info"><i class="fa fa-check" aria-hidden="true"></i> VERIFIED</span>';
														}
														else
														{
											...
											<i class="fa fa-heart fa-2x cart" aria-hidden="true" style="position:absolute;top:0;left:0;"></i>
										</li><!-- /.ITEM -->';
									}
				?>
				</ul>
