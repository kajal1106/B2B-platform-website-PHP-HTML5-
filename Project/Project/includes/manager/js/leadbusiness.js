...
$(document).ready(function(){
  ...
  $('.displaybusinesslead').each(function(){
         ...
         x.style.display = "block";
            ...
            $.ajax({
                      ...
                      .done(function(data){
                        //console.log(data);
                        x.style.display = "none";
                        $('.viewbusinesslead').html(data);
                        //console.log(data);
                      });
       });
     });
    $(".editbusinesslead").click(function(){
    $( "#leadname" ).prop( "disabled", false );
    $( "#leaddesc" ).prop( "disabled", false );
    $( ".savebusinesslead" ).prop( "disabled", false );
  });
      $(".savebusinesslead").click(function(){
      $( "#leadname" ).prop( "disabled", true );
      $( "#leaddesc" ).prop( "disabled", true );
      $( ".savebusinesslead" ).prop( "disabled", true );
      $.ajax({
        type: "POST",
        url: "updatebusinesslead.php",
        data: {'id' : id,
