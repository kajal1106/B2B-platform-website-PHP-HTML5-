                                                ...
                                                <td><?php echo $row[6];?></td>
                                                  <td class="text-center">
                                                    <div class="btn-group">
                                                       ...
                                                       <button  title="Delete"  class="btn btn-xs btn-danger delpro" id="<?php  echo $row[0]; ?>" data-toggle="modal" data-target="#delete_client" style="margin-left:5px;"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php $i++; }?>
...
<h3 class="text-center">You cannot revoke this action...</h3>
      ...
      <div class="modal-footer">
        <button type="button" id ="deleteproduct" class="btn btn-danger deleteproduct">Yes</button>
