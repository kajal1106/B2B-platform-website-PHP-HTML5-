	  ...
	  if($errors==1)
	  {
	  ...
	  }else if(!empty($fileName))
	    {
	      $location = "Mylogo/";
			...
			<p>To activate your account, please click on this link: <a href='".DIR."activate.php?x=$businessID&y=$activasion'>".DIR."activate.php?x=$businessID&y=$activasion</a></p>
...
$clientID = $db->lastInsertId('clientID');
			...
			$subject = "Registration Confirmation";
			$body = "<p>Thank you for registering at thebizroot site.</p>
			<p>To activate your account, please click on this link: <a href='".DIR."activate.php?x=$clientID&y=$activasion'>".DIR."activate.php?x=$clientID&y=$activasion</a></p>
			<p>Regards Site Admin</p>";
