            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="">Sub-Industries</a></li>
                    </ul>
                    <!-- END Navigation info -->
...
<input type="submit" class="btn btn-success col-sm-offset-5" style="margin-top:2%;" name="Add" value="Add Industry">
                    ...
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-sm-offset-1 col-sm-10" style="background-color:#e9e9e9;padding:5%;">
                          <h3 style="margin-top:-2%;text-align:center;">Sub-Industries</h3>
                          ...
                          <input type="submit" class="btn btn-success col-sm-offset-5" style="margin-top:3%;" name="Add" value="Add Industry">
                        </div>
                      </div>
                    </div>
                    <!-- Nav Dash -->
