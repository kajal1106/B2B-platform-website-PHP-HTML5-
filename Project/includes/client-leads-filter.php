						...
						<div class="sidebar sidebar-wrap ">
								...
								<div class="sidebar-widget-title">
									...
									<div class="sidebar-widget-title margin-top-10">
										<ul>
											<li class="filter-tab-1"><a href="business-leads.php" class="col-black">Business Leads</a></li>
											<li class="filter-tab-1 act"><a href="client-leads.php" class="col-black">Client Leads</a></li>
									...
									<div class="sidebar-category-widget-wrap">
										<ul id="myUL2">
											<?php
 						            			...
 						            			{
 													?>
												<li  class="ind single-line-filter" style="display:none" ><a class="single-line-filter col-black"><input type="checkbox" class="item_filter industry" value="<?php echo $row['industryID'];?>"  <?php if(in_array($row['industryID'],$industry)){ echo"checked"; } ?>> <?php echo $row["industryName"];?> </a></li>
											<?php
										 }
										 ?>
										</ul>
										...
										<ul id="myUL1">
											<?php
											 ...
											 while($row = $stmt->fetch(PDO::FETCH_ASSOC))
												{
 						             ?>
 											<li class='ind_b' style="display:none;" ><a  class="col-black" ><input type="checkbox" class="item_filter country" value="<?php echo $row['countryID']; ?>" <?php if(in_array($row['countryID'],$country)){ echo"checked"; } ?> > <?php echo $row["countryName"] ?></a></li>
