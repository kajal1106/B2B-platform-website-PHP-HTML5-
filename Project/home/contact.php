			...
			<div class="container">
					...
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"><!-- infobox -->
						<div class="info-box bgwhite shadow-1 clearfix">
							...
							<div class="info-content">
								...
								<div class="info-disc">
									<p>0 800 55 22 55 <br>0 700 77 21 85</p>
								</div>
							</div>
						</div>
					</div><!-- infobox end -->
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"><!-- infobox -->
						<div class="info-box bgwhite shadow-1 clearfix">
							...
							<div class="info-content">
								...
								<div class="info-disc">
									<p>help@designsvilla.com<br>support@designsvilla.com</p>
								</div>
							</div>
						</div>
					</div><!-- infobox end -->
				...
				<div class="contact-form-wrap margin-top-30"><!--.contact-form-wrap -->
					<div id="contact_form" class="row contact-form"><!-- .row .contact-form -->
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"><!-- form-field -->
							<input class="input-field" type="text" placeholder="WEBSITE" name="website" required="required">
						</div><!-- form-field  end-->
