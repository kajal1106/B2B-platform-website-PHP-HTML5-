...
?>
		...
		<section class="aside-layout-section padding-top-60 padding-bottom-40">
			<div class="container"><!-- section container -->
				...
				<div class="row"><!-- row -->
          <?php include('includes/business-leads-filter.php');?>
					<div class="col-md-9 col-sm-8 col-xs-12 main-wrap"><!-- content area column -->
						<div class="blog-section padding-bottom-40">
							
                  <?php
                  $query ='SELECT DISTINCT industrylist.industryName, businesslead.businessName, businesslead.leadName, businesslead.leadDescription, businesslead.offerType, businesslead.businessleadid, country.countryName, businesslead.dateofpost,country.countryFlag, businessleadimage.imagePath FROM businesslead
                    ...
                    if(!empty($industry)){
                      ...
                      $query  .= " and businesslead.industryID in('$industrydata')";
                    }
                    ...
                    if(!empty($type)){
                     ...
                     $query  .= " and offerType in('$typedata')";
                   }

                    $query  .= ' group by businessLeadID ';
                  ...
                  while($row = $stmtfetch->fetch(PDO::FETCH_GROUP))
                        {
								...
								<div class="entry-figure col-md-2 col-lg-2 col-sm-2 col-xs-12 ">
									<a href="lead-single-listing.php?lid='.$row[5].'"><img class="business-logo thumbnail  img-responsive image-rounded " style="margin:0% auto;" src="'.$row[9].'" alt="IMG NOT AVAILABLE" ></a>
								</div>
								<div class="col-md-10  col-sm-10 col-xs-12 col-lg-10">
									<div class="entry-title">
										<a href="lead-single-listing.php?lid='.$row[5].'"><h6 class="lead-title col-black">'.$row[2].'</h6></a>
										<span class="label uppercase pull-right " style="background-color:#0b3c5d;">'.$row[4].'</span>
									...
									<div class=" pull-right">
										<a href="lead-single-listing.php?lid='.$row[5].'">Read More</a>
									</div>
									</div>
    ...
    $(document).on('click','.item_filter',function(){
      ...
      var url ="business-leads.php?industry="+industry+"&country="+country+"&type="+type;
      window.location=url;
    });
