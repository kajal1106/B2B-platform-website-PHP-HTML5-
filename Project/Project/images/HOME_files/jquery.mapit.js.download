...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			styles: 'GRAYSCALE',
			locations: [
				[20.5937, 78.9629, 'images/map-markers/purpal1.png', 'listing', '<div class="infobox-wrap clearfix"><div class="infobox-figure"><img src="images/map-infobox.jpg" alt="listing"/></div><div class="infobox-content"><h5>post title</h5><div class="infobox-rattings"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div><div class="address"><p>India,<br/>London, NW11 8EN</p></div></div></div>', false, '0'],
