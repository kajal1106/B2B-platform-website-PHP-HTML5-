<?php
$query='SELECT DISTINCT business.businessID, businesscontactinformation.businessName, industrylist.industryName, businessprofile.aboutCompany, country.countryName, country.countryFlag, businesslogo.busienssLogoPath, businessprofile.levelToExpand, businessprofile.status, businessprofile.isverified FROM business
								...
								<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12" >
									...
									<hr>
										<ul>
											...
											<li class="capitalize inline col-black strong"><i class="fa fa-user green-1"></i>Industryre: '.$row[2].'</li>';
											if($row[8]=="FEATURED")
											{
											
											echo '<li class="capitalize  inline col-black strong"><label class="label" style="background-color:orange;">FEATURE</label></li>';}
											if($row[9]=="Verify")
											{
