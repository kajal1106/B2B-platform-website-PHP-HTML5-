                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="addindustry">
                                          ...
                                          <div class="input-group">
                                            ...
                                            <input type="text" id="example-input-prepend2" name="addindustry" class="form-control" placeholder="Enter Industry Name">
                                        </div>
...
<div class="tab-pane" id="addsubindustry">
  ...
  <form action="addsubindustry.php" method="POST">
      ...
      <div class="col-sm-8">
      <input type="text"  id="example-input-prepend2" name="subindustry" class="form-control" placeholder="Enter Industry Name">
      </div>
      </div>
