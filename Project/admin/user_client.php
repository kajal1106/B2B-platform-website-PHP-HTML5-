                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <div class="btn-group">
                                                        ...
                                                        <button  title="Delete"  class="btn btn-xs btn-danger delclient" id="<?php echo $row[0];?>" data-toggle="modal" data-target="#delete_client" style="margin-left:5px;"><i class="fa fa-times"></i></button>
...
<h3 class="text-center">You cannot revoke this action...</h3>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger deleteclient">Yes</button>
