           ...
           var news  = $('#news').val();
        	...
        	<div class="col-md-3 footer-ns animated fadeInRight">
              <!--a href="index.php"  style="margin-left:30px;"><img src="images/footer-logo.png" /></a><br-->
                <p style="color:white">"Globally growing B2B and B2C, business marketing platform for small, medium and large scale businesses, Register Now For Free!"</p>

            	   <h4 style="font-size:1.3rem;">Newsletter</h4>
...
.pad
{
    ...
    <div class="container">
      <div class="row">
        ...
        <!--left text-->
        <div class="col-md-4">
          <div class="left-text pad"> &copy; 2018 Vamps MEGACORP LLP. </div>
        </div>
         <div class="col-md-8 offset-md-8" style="text-align:right;">
          <div class="left-text pad" > Developed By <a class="inline-hyperlink" href="http://www.steinnlabs.com">Nainsha </a> </div>
        </div>
        <!--Right menu-->
        <div class="col-md-4">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-112978211-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-112978211-1');
</script>
