...
<div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-4 col-lg-4 menu-align" >
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                      ...
                      <?php
                         ...
                         {
                          echo '<li><a href="http://thebizroot.com/home/businesses.php?industry='.$row1['industryID'].'&country=&type=&subindustry='.$row1['IndustrySublistID'].'" title="">'.$row1['subindustryName'].'</a></li>';
                        }
...
<li><a href="" title=""> <span class="col-white"><i class="fa fa-bars"></i> Browse All Categories</a></span></li>
