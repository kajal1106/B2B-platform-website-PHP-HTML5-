				...
				<div class="row category-section-wrap cat-style-3">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 main-wrap"><!-- category column -->
						...
						<div class="cat-wrap shadow-1">
							...
							<a href="http://thebizroot.com/home/businesses.php?industry=<?php echo htmlspecialchars($row['industryID']) ?>&country=&type=&subindustry=" ><h5 class="cat-title"><?php echo htmlspecialchars($row['industryName']) ?></h5></a>
