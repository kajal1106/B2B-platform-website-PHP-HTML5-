        ...
        <tbody>
          ...
          ?>
            <tr>
                ...
                <button data-toggle="modal" class ="clientlead" data-target="#clientlead" id="<?php echo $row['clientLeadId']?>"><i class="fa fa-search" area-hidden="true" ></i></button>
                <button data-toggle="modal" class="clientleadrefer" data-target="#referlead" id="<?php echo $row['clientLeadId']?>" tooltip="refer"><i class="fa fa-location-arrow" area-hidden="true" ></i></button>
